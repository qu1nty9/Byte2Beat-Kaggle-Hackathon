...
Run `make submission-check` before publishing. It validates required files, result schemas, claims-ledger evidence links, notebook execution status, figure readability, and notebook path hygiene.
